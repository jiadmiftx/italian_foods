...
ListItalianMeal listItalianMealFromJson(String str) => ListItalianMeal.fromJson(json.decode(str));

String listItalianMealToJson(ListItalianMeal data) => json.encode(data.toJson());

class ListItalianMeal {
    ListItalianMeal({
        this.meals,
    });
    ...
    factory ListItalianMeal.fromJson(Map<String, dynamic> json) => ListItalianMeal(
